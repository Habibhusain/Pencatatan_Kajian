    ...
    function tampil_kajian() {

        $sql_tampil_kajian = "SELECT * FROM kajian";
        $eksekusi_tampil_kajian = connect_db()->query($sql_tampil_kajian);
        $result = array();

        while ($row = $eksekusi_tampil_kajian->fetch_assoc()) {
            $result[]= $row;
        }
    ...
    function ambil_semua_kajian_dengan_user() {
        ...
        $sql_ambil_semua_kajian_dengan_user = " SELECT kajian.pengisi, 
                kajian.tema, 
                kajian.tempat, 
                kajian.deskripsi, 
            ...
            FROM 
                kajian 
            JOIN 
                user ON kajian.user_id = user.user_id
        ";
